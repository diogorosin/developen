...
import developen.common.subject.i18n.AcronymTag;
...
public class StateSearchView extends TableSearchView {


	private static final long serialVersionUID = 8367598621969621935L;
	...
	public StateSearchView(SearchController controller) {
	...
	protected Table getResultComponent() {
		...
		if (recordTable == null){
			...
			recordTable.getColumnModel().getColumn(ACRONYM_COLUMN_INDEX).setPreferredWidth(70);
			
			recordTable.getColumnModel().getColumn(ACRONYM_COLUMN_INDEX).setMaxWidth(70);

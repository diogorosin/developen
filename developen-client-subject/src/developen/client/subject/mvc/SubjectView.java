...
import developen.common.subject.i18n.PreferencesTag;
...
public abstract class SubjectView extends EntryView {
	...
	public DBTextField getRuleField() {
		...
		if (ruleField == null){
			...
			ruleField = new DBTextField(new RuleTag(), SubjectController.RULE_PROPERTY);
	...
	public DBRowPanel getPreferencesTab(){
		...
		if (preferencesTab == null){
			...
			preferencesTab = new DBRowPanel(120);

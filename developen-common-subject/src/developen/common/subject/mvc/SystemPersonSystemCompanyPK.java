...
@Embeddable
public class SystemPersonSystemCompanyPK implements Serializable{
	...
	public SystemPersonSystemCompanyPK(){
		
		
	};
	
	
	public SystemPersonSystemCompanyPK(SystemPerson systemPerson, SystemCompany systemCompany){
	...
	public boolean equals(Object obj) {
		...
		SystemPersonSystemCompanyPK other = (SystemPersonSystemCompanyPK) obj;

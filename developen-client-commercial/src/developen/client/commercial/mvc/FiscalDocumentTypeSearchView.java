...
public class FiscalDocumentTypeSearchView extends TableSearchView {
	...
	public FiscalDocumentTypeSearchView(SearchController controller) {
	...
	public Tag getInternalFrameTitle() {
		...
		return new FiscalDocumentTypeTag(); 
	...
	public Class<? extends Model> getMimeType(){
		...
		return FiscalDocumentType.class;

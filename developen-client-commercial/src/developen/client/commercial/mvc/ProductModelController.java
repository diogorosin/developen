...
public class ProductModelController extends EntryController {
	...
	public void changeIdentifierProperty(Long newValue) throws Exception {
		...
		setModelProperty(ProductModelController.IDENTIFIER_PROPERTY, newValue);
	...
	public void changeDenominationProperty(String newValue) throws Exception {
		...
		setModelProperty(ProductModelController.DENOMINATION_PROPERTY, newValue);
	...
	public void changeShortDenominationProperty(String newValue) throws Exception {
		...
		setModelProperty(ProductModelController.SHORT_DENOMINATION_PROPERTY, newValue);
	...
	public void onClear() throws Exception{
		...
		setModelProperty(ProductModelController.IDENTIFIER_PROPERTY, null);

		setModelProperty(ProductModelController.DENOMINATION_PROPERTY, null);
		
		setModelProperty(ProductModelController.SHORT_DENOMINATION_PROPERTY, null);

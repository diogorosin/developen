...
public class MeasureUnitSearchController extends SearchController {
	
	
	public MeasureUnitSearchModel getModel(){

		return (MeasureUnitSearchModel) super.getModel();
	...
	public ColumnQuery buildQuery(){
		...
		ColumnQuery query = new ColumnQuery(MeasureUnit.class);

...
@Table
public class Rule extends Model implements Entry, Search {
	
	
	private static final long serialVersionUID = 664598812235831264L;
	...
	public Rule(Long indentifier, String denomination){

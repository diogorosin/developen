...
@Table
public class Ipi extends Model implements Entry, Search{
	...
	public void setRules(List<IpiRule> newValue) {


		List<IpiRule> oldValue = this.rules;
